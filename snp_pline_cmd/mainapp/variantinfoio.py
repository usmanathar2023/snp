...
class VarintInfoIO:
    ...
    totalSNPs=0;
    genId=''
    def parseMyVarinats(self, fabricatedTerm,genId):
        ...
        self.chekboxValues = list(input('Enter 1 for sift, 2 for sift4g, 3 for provean, 4 for mvp, 5 for polyphen2HVAR, 6 for polyphen2HDIV \n'
                            ',7 primateAI, 8 for revel, 9 for mpc, 10 for mutpred, 11 for mutation taster, 12 for mutation assessor \n'
                            ', 13 for meta rnn , 14 for meta svm, 15 for mcap, 16 for ls2, 17 for fathmm, 18 for fathmm-xf \n'
                            ',19 for fathmm-mkl, 20 for bayesdel-addAF, 21 for bayesdel-noaf, 22 for vest4, 23 for dann, 24 for eigen \n'
                            ',25 for eigenpc, 26 for deogen2, 27 for genocanyon,28 for all tools or enter multiple options separated by space\n').split())

        if self.chekboxValues.__contains__('28'):
            for x in range(27):
                self.chekboxValues.append(str(x+1))
        ...
        for vars in hgvs37Ids: #varids: for (a, b, c) in itertools.zip_longest(num, color, value, fillvalue=-1):
            ...
            if r.status_code==200:
                ...
                if self.chekboxValues.__contains__('1') and  'sift' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('2') and  'sift4g' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('3') and  'provean' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('4') and  'mvp' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('5') and dbnsfpVarDic.__contains__('polyphen2'):
                ...
                if self.chekboxValues.__contains__('6') and dbnsfpVarDic.__contains__('polyphen2'):
                    tempDic = dbnsfpVarDic.get('polyphen2')
                ...
                if self.chekboxValues.__contains__('7') and  'primateai' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('8') and  'revel' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('9') and  'mpc' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('10') and  'mutpred' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('11') and  'mutationtaster' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('12') and  'mutationassessor' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('13') and  'metarnn' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('14') and  'metasvm' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('15') and  'm-cap' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('16') and  'list-s2' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('17') and  'fathmm' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('18') and  'fathmm-xf' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('19') and  'fathmm-mkl' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('20') and  'bayesdel' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('21') and  'bayesdel' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('22') and  'vest4' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('23') and  'dann' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('24') and  'eigen' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('25') and  'eigen-pc' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('26') and  'deogen2' in dbnsfpVarDic:
                ...
                if self.chekboxValues.__contains__('27') and  'genocanyon' in dbnsfpVarDic:
        ...
        if len(finalAnnotationDataSift) > 0:
            ...
            print('self.siftFile',self.siftFile)
        ...
        if len(self.pathogenicVariants)>0:
            ...
            self.pathogenicVarFile = 'media/' + str(uuid.uuid4()) + '_commoan_pathogenic_variants' + '.csv'
